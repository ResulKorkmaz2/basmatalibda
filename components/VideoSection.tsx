        ...
        >
          <div className="bg-white/90 backdrop-blur-lg rounded-3xl border border-white/30 shadow-2xl max-w-2xl mx-auto p-8">
            ...
            <div className="relative z-10">
              ...
              <a 
                href="tel:0573677385"
                className="inline-flex items-center justify-center px-8 py-4 bg-gradient-to-r from-red-600 to-red-700 hover:from-red-700 hover:to-red-800 text-white rounded-2xl font-bold shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105 group"
              >
