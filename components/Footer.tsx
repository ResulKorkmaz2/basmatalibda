              ...
              <div className="relative">
                ...
                <div className="relative z-10 p-8">
                  ...
                  <div className="flex items-center space-x-4 space-x-reverse">
                    <a
                      href="tel:0573677385"
                      className="group bg-gradient-to-br from-primary-600 to-primary-700 hover:from-primary-700 hover:to-primary-800 p-4 rounded-full transition-all duration-300 transform hover:scale-110 shadow-lg hover:shadow-xl"
                    >
                    ...
                    <a
                      ...
                      className="group bg-gradient-to-br from-green-600 to-green-700 hover:from-green-700 hover:to-green-800 p-4 rounded-full transition-all duration-300 transform hover:scale-110 shadow-lg hover:shadow-xl"
                    >
                    ...
                    <a
                      href="#"
                      className="group bg-gradient-to-br from-pink-600 to-pink-700 hover:from-pink-700 hover:to-pink-800 p-4 rounded-full transition-all duration-300 transform hover:scale-110 shadow-lg hover:shadow-xl"
                    >
                      <Instagram className="w-5 h-5 group-hover:animate-spin" />
                    </a>
                    <a
                      href="#"
                      className="group bg-gradient-to-br from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 p-4 rounded-full transition-all duration-300 transform hover:scale-110 shadow-lg hover:shadow-xl"
                    >
